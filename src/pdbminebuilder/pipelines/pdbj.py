...
from pdbminebuilder.utils.assembly import calculate_mw_for_bu, hex_sha256
from pdbminebuilder.utils.brief_summary import generate_brief_summary
from pdbminebuilder.utils.patches import apply_patches

console = Console()
_default_logger = logging.getLogger("pdbminebuilder.pipelines.pdbj")
    ...
    def process_job(
        ...
        try:
            ...
            if file_mtime is not None:
                try:
                    from pdbminebuilder.db.metadata import upsert_entry_mtime
...
def run_load(
    ...
    from pdbminebuilder.db.loader import run_loader
