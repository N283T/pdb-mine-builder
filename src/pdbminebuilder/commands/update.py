...
from pdbminebuilder.db.loader import ensure_schema
    ...
    try:
        for pipeline_name in pipelines:
            ...
            if not pipeline_config:
                ...
                logging.getLogger("pdbminebuilder.update").warning(msg)
...
def _import_pipeline(name: str):
    ...
    return importlib.import_module(f"pdbminebuilder.pipelines.{name}")
