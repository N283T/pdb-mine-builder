...
brief_summary = Table(
    ...
    Column(
        ...
        Text,
        nullable=True,
        comment="Chemical Component ID of an entry. All tables/categories refer back to this ID in the brief_summary table.",
    ),
    Column(
        "docid",
        BigInteger,
    ...
    Column(
        ...
        Date,
        nullable=True,
        comment="Date that the entry was defined in the dictionary",
    ),
    Column(
        "release_date",
        Date,
        nullable=True,
        comment="Date at which the entry was officially released",
    ),
    Column(
        "pdbx_modified_date",
        Date,
    ...
    Column(
        ...
        ARRAY(Text),
        nullable=True,
        comment="Known synonyms of an entry.",
    ),
    ...
    Column(
        ...
        ARRAY(Text),
        nullable=True,
        comment="SMILES representations of an entry.",
    ),
    Column(
        "inchi",
        ARRAY(Text),
        nullable=True,
        comment="InChI representations of an entry.",
    ),
    Column(
        "canonical_smiles",
        Text,
        nullable=True,
        comment="[pmb] Canonical SMILES generated by RDKit from molecular structure via ccd2rdmol.",
    ),
...
chem_comp = Table(
    ...
    Column(
        ...
        Text,
        nullable=True,
        comment="The identifier for the parent component of the nonstandard component. May be be a comma separated list if this component is derived from multiple components. Items in this indirectly point to _chem_comp.id in the CHEM_COMP category.",
    ),
    ...
    Column(
        ...
        Text,
        nullable=True,
        comment="A preliminary classification used by PDB.",
    ),
    Column(
        "pdbx_ambiguous_flag",
        Text,
        nullable=True,
        comment="A preliminary classification used by PDB to indicate that the chemistry of this component while described as clearly as possible is still ambiguous. Software tools may not be able to process this component definition.",
    ),
    Column(
        "pdbx_replaced_by",
        Text,
        nullable=True,
        comment="Identifies the _chem_comp.id of the component that has replaced this component.",
    ),
    Column(
        "pdbx_replaces",
        Text,
        nullable=True,
        comment="Identifies the _chem_comp.id's of the components which have been replaced by this component. Multiple id codes should be separated by commas.",
    ),
    Column(
        "pdbx_formal_charge",
        Integer,
        nullable=True,
        comment="The net integer charge assigned to this component. This is the formal charge assignment normally found in chemical diagrams.",
    ),
    Column(
        "pdbx_subcomponent_list",
        Text,
        nullable=True,
        comment="The list of subcomponents contained in this component.",
    ),
    Column(
        "pdbx_model_coordinates_details",
        Text,
        nullable=True,
        comment="This data item provides additional details about the model coordinates in the component definition.",
    ),
    Column(
        "pdbx_model_coordinates_db_code",
        Text,
        nullable=True,
        comment="This data item identifies the PDB database code from which the heavy atom model coordinates were obtained.",
    ),
    Column(
        "pdbx_ideal_coordinates_details",
        Text,
        nullable=True,
        comment="This data item identifies the source of the ideal coordinates in the component definition.",
    ),
    Column(
        "pdbx_ideal_coordinates_missing_flag",
        Text,
        nullable=True,
        comment="This data item identifies if ideal coordinates are missing in this definition.",
    ),
    Column(
        "pdbx_model_coordinates_missing_flag",
        Text,
        nullable=True,
        comment="This data item identifies if model coordinates are missing in this definition.",
    ),
    Column(
        "pdbx_initial_date",
        Date,
        nullable=True,
        comment="Date component was added to database.",
    ),
    Column(
        "pdbx_modified_date",
        Date,
        nullable=True,
        comment="Date component was last modified.",
    ),
    Column(
        "pdbx_release_status",
        Text,
    ...
    Column(
        ...
        Text,
        nullable=True,
        comment="This data item identifies the deposition site that processed this chemical component defintion.",
    ),
    Column(
        "pdbx_pcm",
        Text,
        nullable=True,
        comment="A flag to indicate if the CCD can be used to represent a protein modification.",
    ),
...
pdbx_chem_comp_synonyms = Table(
    ...
    Column(
        ...
        Text,
        nullable=True,
        comment="The synonym of this particular chemical component.",
    ),
    Column(
        "provenance", Text, nullable=True, comment="The provenance of this synonym."
    ),
...
pdbx_chem_comp_audit = Table(
    ...
    Column(
        ...
        Text,
        nullable=True,
        comment="An identifier for the wwPDB site creating or modifying the component.",
    ),
    Column(
        "action_type",
        Text,
...
pdbx_chem_comp_related = Table(
    ...
    Column(
        ...
        Text,
        nullable=True,
        comment="The related chemical component for which this chemical component is based.",
    ),
    Column(
        "relationship_type",
        Text,
        nullable=True,
        comment="Describes the type of relationship",
    ),
...
pdbx_chem_comp_atom_related = Table(
    ...
    Column(
        ...
        Text,
        nullable=True,
        comment="The atom identifier/name for the atom mapping",
    ),
    Column(
        "related_atom_id",
        Text,
        nullable=True,
        comment="The atom identifier/name for the atom mapping in the related chemical component",
    ),
    Column(
        "related_type",
        Text,
...
pdbx_chem_comp_pcm = Table(
    ...
    Column(
        "pcm_id", Integer, nullable=True, comment="An ordinal index for this category."
    ),
    Column(
        "modified_residue_id",
        Text,
    ...
    Column(
        ...
        Text,
        nullable=True,
        comment="The position of the modification on the amino acid.",
    ),
    Column(
        "polypeptide_position",
        Text,
        nullable=True,
        comment="The position of the modification on the polypeptide.",
    ),
    Column(
    ...
    Column(
        ...
        Text,
        nullable=True,
        comment="The UniProt PTM accession code that is an exact match for the protein modification.",
    ),
    Column(
        "uniprot_generic_ptm_accession",
        Text,
        nullable=True,
        comment="The UniProt PTM accession code that describes the group of PTMs of which this protein modification is a member.",
    ),
