...
pdbx_reference_molecule_family = Table(
    ...
    Column("release_status", Text, nullable=True, comment="Assigns the current PDB release status for this family."),
    PrimaryKeyConstraint("family_prd_id"),
    # FK: (family_prd_id) -> brief_summary(family_prd_id)
    info={
        "keywords": ["name"],
...
pdbx_reference_molecule_list = Table(
    ...
    metadata,
    Column("family_prd_id", Text, nullable=True, comment="The value of _pdbx_reference_molecule_list.family_prd_id is a reference to _pdbx_reference_molecule_family.family_prd_id' in category PDBX_REFERENCE_MOLECULE_FAMILY."),
    Column("prd_id", Text, nullable=True, comment="The value of _pdbx_reference_molecule_list.prd_id is the unique identifier for the reference molecule in this family. By convention this ID uniquely identifies the reference molecule in in the PDB reference dictionary. The ID has the template form PRD_dddddd (e.g. PRD_000001)"),
...
pdbx_reference_molecule_synonyms = Table(
    ...
    metadata,
    Column("family_prd_id", Text, nullable=True, comment="The value of _pdbx_reference_molecule_synonyms.family_prd_id is a reference to _pdbx_reference_molecule_list.family_prd_id in category PDBX_REFERENCE_MOLECULE_FAMILY_LIST."),
    Column("prd_id", Text, nullable=True, comment="The value of _pdbx_reference_molecule_synonyms.prd_id is a reference _pdbx_reference_molecule.prd_id in the PDBX_REFERENCE_MOLECULE category."),
    Column("ordinal", Integer, nullable=True, comment="The value of _pdbx_reference_molecule_synonyms.ordinal is an ordinal to distinguish synonyms for this entity."),
    Column("name", Text, nullable=True, comment="A synonym name for the entity."),
    Column("source", Text, nullable=True, comment="The source of this synonym name for the entity."),
...
pdbx_reference_molecule_annotation = Table(
    ...
    metadata,
    Column("family_prd_id", Text, nullable=True, comment="The value of _pdbx_reference_molecule_annotation.family_prd_id is a reference to _pdbx_reference_molecule_list.family_prd_id in category PDBX_REFERENCE_MOLECULE_FAMILY_LIST."),
    Column("prd_id", Text, nullable=True, comment="This data item is a pointer to _pdbx_reference_molecule.prd_id in the PDB_REFERENCE_MOLECULE category."),
    Column("ordinal", Integer, nullable=True, comment="This data item distinguishes anotations for this entity."),
    Column("text", Text, nullable=True, comment="Text describing the annotation for this entity."),
    Column("type", Text, nullable=True, comment="Type of annotation for this entity."),
    Column("source", Text, nullable=True, comment="The source of the annoation for this entity."),
...
pdbx_reference_molecule_features = Table(
    ...
    metadata,
    Column("family_prd_id", Text, nullable=True, comment="The value of _pdbx_reference_molecule_features.family_prd_id is a reference to _pdbx_reference_molecule_list.family_prd_id in category PDBX_REFERENCE_MOLECULE_FAMILY_LIST."),
    Column("prd_id", Text, nullable=True, comment="The value of _pdbx_reference_molecule_features.prd_id is a reference _pdbx_reference_molecule.prd_id in the PDBX_REFERENCE_MOLECULE category."),
    Column("ordinal", Integer, nullable=True, comment="The value of _pdbx_reference_molecule_features.ordinal distinguishes each feature for this entity."),
    Column("source_ordinal", Integer, nullable=True, comment="The value of _pdbx_reference_molecule_features.source_ordinal provides the priority order of features from a particular source or database."),
...
pdbx_reference_molecule_related_structures = Table(
    ...
    metadata,
    Column("family_prd_id", Text, nullable=True, comment="The value of _pdbx_reference_molecule_related_structures.family_prd_id is a reference to _pdbx_reference_molecule_list.family_prd_id in category PDBX_REFERENCE_MOLECULE_FAMILY_LIST."),
    Column("ordinal", Integer, nullable=True, comment="The value of _pdbx_reference_molecule_related_structures.ordinal distinguishes related structural data for each entity."),
    Column("db_name", Text, nullable=True, comment="The database name for the related structure reference."),
    Column("db_code", Text, nullable=True, comment="The database identifier code for the related structure reference."),
    Column("db_accession", Text, nullable=True, comment="The database accession code for the related structure reference."),
    Column("name", Text, nullable=True, comment="The chemical name for the structure entry in the related database"),
    ...
    Column("citation_id", Text, nullable=True, comment="A link to related reference information in the citation category."),
    PrimaryKeyConstraint("family_prd_id", "ordinal"),
    # FK: (family_prd_id) -> brief_summary(family_prd_id)
    info={
...
pdbx_family_prd_audit = Table(
    ...
    metadata,
    Column("family_prd_id", Text, nullable=True, comment="This data item is a pointer to _pdbx_reference_molecule_family.family_prd_id in the pdbx_reference_molecule category."),
    Column("date", Date, nullable=True, comment="The date associated with this audit record."),
    Column("processing_site", Text, nullable=True, comment="An identifier for the wwPDB site creating or modifying the family."),
