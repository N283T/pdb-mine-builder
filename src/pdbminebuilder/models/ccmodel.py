...
brief_summary = Table(
    "brief_summary",
    metadata,
    Column("model_id", Text, nullable=True, comment="Model ID of an entry. All tables/categories refer back to this ID in the brief_summary table."),
...
pdbx_chem_comp_model = Table(
    ...
    metadata,
    Column("model_id", Text, nullable=True, comment="Model ID of an entry. All tables/categories refer back to this ID in the brief_summary table."),
    Column("id", Text, nullable=True, comment="The value of _pdbx_chem_comp_model.id must uniquely identify each model instance the PDBX_CHEM_COMP_MODEL list."),
    Column("comp_id", Text, nullable=True, comment="An identifier for chemical component definition."),
...
pdbx_chem_comp_model_atom = Table(
    ...
    metadata,
    Column("model_id", Text, nullable=True, comment="Model ID of an entry. All tables/categories refer back to this ID in the brief_summary table."),
    Column("atom_id", Text, nullable=True, comment="The value of _pdbx_chem_comp_model_atom.atom_id uniquely identifies each atom in the PDBX_CHEM_COMP_MODEL_ATOM list."),
    Column("ordinal_id", Integer, nullable=True, comment="The value of _pdbx_chem_comp_model_atom.ordinal_id is an ordinal identifer for each atom in the PDBX_CHEM_COMP_MODEL_ATOM list."),
    ...
    Column("model_Cartn_x", Double, nullable=True, comment="The x component of the coordinates for this atom in this component model specified as orthogonal angstroms."),
    Column("model_Cartn_y", Double, nullable=True, comment="The y component of the coordinates for this atom in this component model specified as orthogonal angstroms."),
    Column("model_Cartn_z", Double, nullable=True, comment="The z component of the coordinates for this atom in this component model specified as orthogonal angstroms."),
...
pdbx_chem_comp_model_bond = Table(
    ...
    metadata,
    Column("model_id", Text, nullable=True, comment="Model ID of an entry. All tables/categories refer back to this ID in the brief_summary table."),
    Column("atom_id_1", Text, nullable=True, comment="The ID of the first of the two atoms that define the bond. This data item is a pointer to _pdbx_chem_comp_model_atom.atom_id in the PDBX_CHEM_COMP_MODEL_ATOM category."),
    Column("atom_id_2", Text, nullable=True, comment="The ID of the second of the two atoms that define the bond. This data item is a pointer to _pdbx_chem_comp_model_atom.atom_id in the PDBX_CHEM_COMP_MODEL_ATOM category."),
    ...
    Column("ordinal_id", Integer, nullable=True, comment="The value of _pdbx_chem_comp_model_bond.ordinal_id is an ordinal identifer for each atom in the PDBX_CHEM_COMP_MODEL_BOND list."),
...
pdbx_chem_comp_model_feature = Table(
    ...
    metadata,
    Column("model_id", Text, nullable=True, comment="Model ID of an entry. All tables/categories refer back to this ID in the brief_summary table."),
    Column("feature_name", Text, nullable=True, comment="The component model feature type."),
    Column("feature_value", Text, nullable=True, comment="The component feature value."),
