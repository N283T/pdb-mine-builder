...
brief_summary = Table(
    "brief_summary",
    metadata,
    Column("prd_id", Text, nullable=True, comment="PRDID of an entry. All tables/categories refer back to the PRDID in the brief_summary table."),
    ...
    Column("pdbx_initial_date", Date, nullable=True, comment="Inclusion date to the PDB of an entry"),
...
chem_comp_atom = Table(
    ...
    Column("pdbx_ref_id", Text, nullable=True, comment="A reference to _pdbx_reference_entity_list.ref_entity_id"),
...
pdbx_reference_molecule = Table(
    ...
    Column("type", Text, nullable=True, comment="Defines the structural classification of the entity."),
    Column("type_evidence_code", Text, nullable=True, comment="Evidence for the assignment of _pdbx_reference_molecule.type"),
    Column("class", Text, nullable=True, comment="Broadly defines the function of the entity."),
    Column("class_evidence_code", Text, nullable=True, comment="Evidence for the assignment of _pdbx_reference_molecule.class"),
    Column("name", Text, nullable=True, comment="A name of the entity."),
    Column("represent_as", Text, nullable=True, comment="Defines how this entity is represented in PDB data files."),
    Column("chem_comp_id", Text, nullable=True, comment="For entities represented as single molecules, the identifier corresponding to the chemical definition for the molecule."),
    Column("compound_details", Text, nullable=True, comment="Special details about this molecule."),
    Column("description", Text, nullable=True, comment="Description of this molecule."),
    Column("representative_PDB_id_code", Text, nullable=True, comment="The PDB accession code for the entry containing a representative example of this molecule."),
    Column("release_status", Text, nullable=True, comment="Defines the current PDB release status for this molecule definition."),
    Column("replaces", Text, nullable=True, comment="Assigns the identifier for the reference molecule which have been replaced by this reference molecule. Multiple molecule identifier codes should be separated by commas."),
    Column("replaced_by", Text, nullable=True, comment="Assigns the identifier of the reference molecule that has replaced this molecule."),
    PrimaryKeyConstraint("prd_id"),
    # FK: (prd_id) -> brief_summary(prd_id)
    info={
        "keywords": [
...
pdbx_reference_entity_list = Table(
    ...
    metadata,
    Column("prd_id", Text, nullable=True, comment="PRDID of an entry. All tables/categories refer back to the PRDID in the brief_summary table."),
    Column("ref_entity_id", Text, nullable=True, comment="The value of _pdbx_reference_entity_list.ref_entity_id is a unique identifier the a constituent entity within this reference molecule."),
    Column("type", Text, nullable=True, comment="Defines the polymer characteristic of the entity."),
    Column("details", Text, nullable=True, comment="Additional details about this entity."),
    Column("component_id", Integer, nullable=True, comment="The component number of this entity within the molecule."),
...
pdbx_reference_entity_nonpoly = Table(
    ...
    metadata,
    Column("prd_id", Text, nullable=True, comment="PRDID of an entry. All tables/categories refer back to the PRDID in the brief_summary table."),
    Column("ref_entity_id", Text, nullable=True, comment="The value of _pdbx_reference_entity_nonpoly.ref_entity_id is a reference to _pdbx_reference_entity_list.ref_entity_id in PDBX_REFERENCE_ENTITY_LIST category."),
    Column("name", Text, nullable=True, comment="A name of the non-polymer entity."),
    Column("chem_comp_id", Text, nullable=True, comment="For non-polymer entities, the identifier corresponding to the chemical definition for the molecule."),
...
pdbx_reference_entity_link = Table(
    ...
    metadata,
    Column("prd_id", Text, nullable=True, comment="PRDID of an entry. All tables/categories refer back to the PRDID in the brief_summary table."),
    Column("link_id", Integer, nullable=True, comment="The value of _pdbx_reference_entity_link.link_id uniquely identifies linkages between entities with a molecule."),
    Column("ref_entity_id_1", Text, nullable=True, comment="The reference entity id of the first of the two entities joined by the linkage. This data item is a pointer to _pdbx_reference_entity_list.ref_entity_id in the PDBX_REFERENCE_ENTITY_LIST category."),
    Column("ref_entity_id_2", Text, nullable=True, comment="The reference entity id of the second of the two entities joined by the linkage. This data item is a pointer to _pdbx_reference_entity_list.ref_entity_id in the PDBX_REFERENCE_ENTITY_LIST category."),
    Column("entity_seq_num_1", Integer, nullable=True, comment="For a polymer entity, the sequence number in the first of the two entities containing the linkage. This data item is a pointer to _pdbx_reference_entity_poly_seq.num in the PDBX_REFERENCE_ENTITY_POLY_SEQ category."),
    Column("entity_seq_num_2", Integer, nullable=True, comment="For a polymer entity, the sequence number in the second of the two entities containing the linkage. This data item is a pointer to _pdbx_reference_entity_poly_seq.num in the PDBX_REFERENCE_ENTITY_POLY_SEQ category."),
    ...
    Column("atom_id_1", Text, nullable=True, comment="The atom identifier/name in the first of the two entities containing the linkage."),
    Column("atom_id_2", Text, nullable=True, comment="The atom identifier/name in the second of the two entities containing the linkage."),
    Column("value_order", Text, nullable=True, comment="The bond order target for the chemical linkage."),
    Column("component_1", Integer, nullable=True, comment="The entity component identifier for the first of two entities containing the linkage."),
    Column("component_2", Integer, nullable=True, comment="The entity component identifier for the second of two entities containing the linkage."),
    Column("link_class", Text, nullable=True, comment="A code indicating the entity types involved in the linkage."),
...
pdbx_reference_entity_poly_link = Table(
    ...
    metadata,
    Column("prd_id", Text, nullable=True, comment="PRDID of an entry. All tables/categories refer back to the PRDID in the brief_summary table."),
    Column("link_id", Integer, nullable=True, comment="The value of _pdbx_reference_entity_poly_link.link_id uniquely identifies a linkage within a polymer entity."),
    Column("ref_entity_id", Text, nullable=True, comment="The reference entity id of the polymer entity containing the linkage. This data item is a pointer to _pdbx_reference_entity_poly.ref_entity_id in the PDBX_REFERENCE_ENTITY_POLY category."),
    Column("component_id", Integer, nullable=True, comment="The entity component identifier entity containing the linkage."),
    Column("entity_seq_num_1", Integer, nullable=True, comment="For a polymer entity, the sequence number in the first of the two components making the linkage. This data item is a pointer to _pdbx_reference_entity_poly_seq.num in the PDBX_REFERENCE_ENTITY_POLY_SEQ category."),
    Column("entity_seq_num_2", Integer, nullable=True, comment="For a polymer entity, the sequence number in the second of the two components making the linkage. This data item is a pointer to _pdbx_reference_entity_poly_seq.num in the PDBX_REFERENCE_ENTITY_POLY_SEQ category."),
    Column("comp_id_1", Text, nullable=True, comment="The component identifier in the first of the two components making the linkage. This data item is a pointer to _pdbx_reference_entity_poly_seq.mon_id in the PDBX_REFERENCE_ENTITY_POLY_SEQ category."),
    Column("comp_id_2", Text, nullable=True, comment="The component identifier in the second of the two components making the linkage. This data item is a pointer to _pdbx_reference_entity_poly_seq.mon_id in the PDBX_REFERENCE_ENTITY_POLY_SEQ category."),
    Column("atom_id_1", Text, nullable=True, comment="The atom identifier/name in the first of the two components making the linkage."),
    Column("atom_id_2", Text, nullable=True, comment="The atom identifier/name in the second of the two components making the linkage."),
    Column("value_order", Text, nullable=True, comment="The bond order target for the non-standard linkage."),
...
pdbx_reference_entity_poly = Table(
    ...
    metadata,
    Column("prd_id", Text, nullable=True, comment="PRDID of an entry. All tables/categories refer back to the PRDID in the brief_summary table."),
    Column("ref_entity_id", Text, nullable=True, comment="The value of _pdbx_reference_entity_poly.ref_entity_id is a reference to _pdbx_reference_entity_list.ref_entity_id in PDBX_REFERENCE_ENTITY_LIST category."),
    Column("type", Text, nullable=True, comment="The type of the polymer."),
    Column("db_code", Text, nullable=True, comment="The database code for this source information"),
    Column("db_name", Text, nullable=True, comment="The database name for this source information"),
    PrimaryKeyConstraint("prd_id", "ref_entity_id"),
    # FK: (prd_id) -> brief_summary(prd_id)
    info={
...
pdbx_reference_entity_poly_seq = Table(
    ...
    metadata,
    Column("prd_id", Text, nullable=True, comment="PRDID of an entry. All tables/categories refer back to the PRDID in the brief_summary table."),
    Column("ref_entity_id", Text, nullable=True, comment="The value of _pdbx_reference_entity_poly_seq.ref_entity_id is a reference to _pdbx_reference_entity_poly.ref_entity_id in PDBX_REFERENCE_ENTITY_POLY category."),
    Column("mon_id", Text, nullable=True, comment="This data item is the chemical component identifier of monomer."),
    Column("parent_mon_id", Text, nullable=True, comment="This data item is the chemical component identifier for the parent component corresponding to this monomer."),
    Column("num", Integer, nullable=True, comment="The value of _pdbx_reference_entity_poly_seq.num must uniquely and sequentially identify a record in the PDBX_REFERENCE_ENTITY_POLY_SEQ list. This value is conforms to author numbering conventions and does not map directly to the numbering conventions used for _entity_poly_seq.num."),
    Column("observed", Text, nullable=True, comment="A flag to indicate that this monomer is observed in the instance example."),
    Column("hetero", Text, nullable=True, comment="A flag to indicate that sequence heterogeneity at this monomer position."),
...
pdbx_reference_entity_sequence = Table(
    ...
    metadata,
    Column("prd_id", Text, nullable=True, comment="PRDID of an entry. All tables/categories refer back to the PRDID in the brief_summary table."),
    Column("ref_entity_id", Text, nullable=True, comment="The value of _pdbx_reference_entity_sequence.ref_entity_id is a reference to _pdbx_reference_entity_list.ref_entity_id in PDBX_REFERENCE_ENTITY_LIST category."),
    Column("type", Text, nullable=True, comment="The monomer type for the sequence."),
    Column("NRP_flag", Text, nullable=True, comment="A flag to indicate a non-ribosomal entity."),
    PrimaryKeyConstraint("prd_id", "ref_entity_id"),
    # FK: (prd_id) -> brief_summary(prd_id)
    info={
...
pdbx_reference_entity_src_nat = Table(
    ...
    metadata,
    Column("prd_id", Text, nullable=True, comment="PRDID of an entry. All tables/categories refer back to the PRDID in the brief_summary table."),
    Column("ref_entity_id", Text, nullable=True, comment="The value of _pdbx_reference_entity_src_nat.ref_entity_id is a reference to _pdbx_reference_entity_list.ref_entity_id in PDBX_REFERENCE_ENTITY_LIST category."),
    Column("ordinal", Integer, nullable=True, comment="The value of _pdbx_reference_entity_src_nat.ordinal distinguishes source details for this entity."),
    Column("organism_scientific", Text, nullable=True, comment="The scientific name of the organism from which the entity was isolated."),
    Column("strain", Text, nullable=True, comment="The strain of the organism from which the entity was isolated."),
    Column("taxid", Text, nullable=True, comment="The NCBI TaxId of the organism from which the entity was isolated."),
    Column("db_code", Text, nullable=True, comment="The database code for this source information"),
    Column("db_name", Text, nullable=True, comment="The database name for this source information"),
    Column("source", Text, nullable=True, comment="The data source for this information."),
...
pdbx_reference_entity_subcomponents = Table(
    ...
    metadata,
    Column("prd_id", Text, nullable=True, comment="PRDID of an entry. All tables/categories refer back to the PRDID in the brief_summary table."),
    Column("seq", Text, nullable=True, comment="The subcomponent sequence for the entity."),
    Column("chem_comp_id", Text, nullable=True, comment="For entities represented as single molecules, the identifier corresponding to the chemical definition for the molecule."),
...
pdbx_prd_audit = Table(
    ...
    Column("processing_site", Text, nullable=True, comment="An identifier for the wwPDB site creating or modifying the molecule."),
