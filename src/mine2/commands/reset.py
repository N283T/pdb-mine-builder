...
def run_reset(
    ...
    if not schemas:
        ...
        console.print("\nUsage:")
        console.print("  mine2 reset cc          # Reset cc schema")
        console.print("  mine2 reset cc pdbj     # Reset multiple schemas")
        console.print("  mine2 reset all         # Reset ALL schemas")
        return
    ...
    console.print("[dim]Run 'mine2 update <pipeline>' to reload data.[/dim]")
