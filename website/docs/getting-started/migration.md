...
pdb-mine-builder produces a database with the **same MINE 2 schema structure**. Existing SQL queries against mine2 databases should work with minimal changes:
